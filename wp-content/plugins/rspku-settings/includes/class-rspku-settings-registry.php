            ...
            'kontak' => [
                ...
                'sections' => [
                    'phone' => [
                        ...
                        'fields' => [
                            ['key' => 'phone_igd', 'label' => 'Call Center 1 (Display)', 'type' => 'text', 'help' => 'Contoh: 0274 512653'],
                            ['key' => 'phone_igd_link', 'label' => 'Call Center 1 (tel: link)', 'type' => 'text', 'help' => 'Format internasional tanpa spasi. Contoh: +62274512653'],
                            ['key' => 'phone_main', 'label' => 'Call Center 2 (Display)', 'type' => 'text', 'help' => 'Contoh: +62 8886412345'],
                            ['key' => 'phone_main_link', 'label' => 'Call Center 2 (tel: link)', 'type' => 'text', 'help' => 'Format internasional tanpa spasi. Contoh: +628886412345'],
                            ['key' => 'whatsapp', 'label' => 'Call Center 3 (Display)', 'type' => 'text', 'help' => 'Contoh: 0274 566129'],
                            ['key' => 'whatsapp_link', 'label' => 'Call Center 3 (tel: link)', 'type' => 'text', 'help' => 'Format internasional tanpa spasi. Contoh: +62274566129'],
            ...
            'homepage' => [
                ...
                'sections' => [
                    ...
                    'promo_slider' => [
                        ...
                        'fields' => [
                            ['key' => 'promo_slide_1_image_id', 'label' => 'Promo 1 - Gambar', 'type' => 'image', 'help' => 'Rasio rekomendasi 4:3, minimal 1200 × 900 px. Alt text mengikuti Media Library.'],
                            ['key' => 'promo_slide_1_cta_url', 'label' => 'Promo 1 - CTA URL', 'type' => 'text', 'help' => 'Gunakan path internal seperti /dokter/ atau URL HTTPS.'],
                            ['key' => 'promo_slide_2_image_id', 'label' => 'Promo 2 - Gambar', 'type' => 'image', 'help' => 'Rasio rekomendasi 4:3, minimal 1200 × 900 px. Alt text mengikuti Media Library.'],
                            ['key' => 'promo_slide_2_cta_url', 'label' => 'Promo 2 - CTA URL', 'type' => 'text', 'help' => 'Gunakan path internal seperti /dokter/ atau URL HTTPS.'],
                            ['key' => 'promo_slide_3_image_id', 'label' => 'Promo 3 - Gambar', 'type' => 'image', 'help' => 'Rasio rekomendasi 4:3, minimal 1200 × 900 px. Alt text mengikuti Media Library.'],
                            ['key' => 'promo_slide_3_cta_url', 'label' => 'Promo 3 - CTA URL', 'type' => 'text', 'help' => 'Gunakan path internal atau URL HTTPS. Kosongkan bila gambar tidak perlu ditautkan.'],
                        ],
                    ],
                    'metrics' => [
