...
final class RSPKU_Settings_Defaults
{
    ...
    public static function all(): array
    {
        return [
            ...
            // Sejarah Kami gallery slots
            'history_hero_image_id' => 0,
            'history_hero_year' => '',
            'history_hero_title' => '',
            'history_hero_caption' => '',
            'history_hero_alt' => '',
            'history_pioneers_image_id' => 0,
            'history_pioneers_year' => '',
            'history_pioneers_title' => '',
            'history_pioneers_caption' => '',
            'history_pioneers_alt' => '',
            'history_child_service_image_id' => 0,
            'history_child_service_year' => '',
            'history_child_service_title' => '',
            'history_child_service_caption' => '',
            'history_child_service_alt' => '',
            'history_first_stone_image_id' => 0,
            'history_first_stone_year' => '',
            'history_first_stone_title' => '',
            'history_first_stone_caption' => '',
            'history_first_stone_alt' => '',
            'history_modernization_image_id' => 0,
            'history_modernization_year' => '',
            'history_modernization_title' => '',
            'history_modernization_caption' => '',
            'history_modernization_alt' => '',
